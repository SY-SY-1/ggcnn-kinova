...
# Load the Network.
MODEL_FILE = '/home/lxl/catkin_ws/src/ggcnn_kinova_grasping/epoch_100_model.hdf5'
...
fx = 624.0937252095787
cx = 318.54048735040385
fy = 625.2180428074618
cy = 241.0188184738833
print "fx cx fy cy:"
print fx, cx, fy, cy
...
def depth_callback(depth_message):
    ...
    with TimeIt('Control'):
        ...
        max_pixel = ((np.array(max_pixel) / 300.0 * crop_size) + np.array(
            [(480 - crop_size) // 2, (640 - crop_size) // 2]))
        ...
        print("pixel coordinate:[u,v]", max_pixel[1], max_pixel[0])
        print("camera coordinate[x,y,z]", x, y, z)
        if np.isnan(z):
            return
...
depth_sub = rospy.Subscriber('/camera/depth/image_rect', Image, depth_callback, queue_size=1)
